...
public class CommentPath {
    ...
    private static final String MIN_CHUNK = java.lang.String.valueOf(CHARSET.charAt(0)).repeat(DEPTH_CHUNK_SIZE);
    private static final String MAX_CHUNK = java.lang.String.valueOf(CHARSET.charAt(CHARSET.length() - 1)).repeat(DEPTH_CHUNK_SIZE);

    public static CommentPath create(String path) {
        if (isDepthOverflow(path)) {
            throw new IllegalArgumentException("Comment path depth overflow");
        }
